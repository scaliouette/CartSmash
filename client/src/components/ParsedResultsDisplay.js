...
function ParsedResultsDisplay({ items, onItemsChange, onDeleteItem, currentUser, parsingStats, savedRecipes, setSavedRecipes, saveCartAsList, selectedRetailer, userZipCode, onShowPriceHistory }) {
  ...
  const getCategoryThumbnail = (category) => {
    const categoryImages = {
      'produce': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#4CAF50"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🥬</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Produce</text></svg>`),
      'dairy': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#03A9F4"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🥛</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Dairy</text></svg>`),
      'meat': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#F44336"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🥩</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Meat</text></svg>`),
      'bakery': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#FF9800"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🍞</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Bakery</text></svg>`),
      'beverages': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#9C27B0"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🥤</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Drinks</text></svg>`),
      'frozen': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#00BCD4"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🧊</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Frozen</text></svg>`),
      'snacks': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#FFC107"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">🍿</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Snacks</text></svg>`),
      'default': 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(`<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#9E9E9E"/><text x="50" y="45" font-family="Arial" font-size="24" text-anchor="middle" fill="white">📦</text><text x="50" y="75" font-family="Arial" font-size="12" font-weight="bold" text-anchor="middle" fill="white">Item</text></svg>`)
    };
